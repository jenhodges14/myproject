angular.module('todo', ['ionic','firebase'])
    ...
    .factory('Projects', function() {
      ...
      .controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
            ...
            $scope.projectsList = $firebase(new Firebase("https://jghmyproject.firebaseio.com/projects"));
            $scope.user = $firebase(new Firebase("https://jghmyproject.firebaseio.com/Users/John"));
